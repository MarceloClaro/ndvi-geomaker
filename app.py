...
# Função para adicionar camadas do Google Earth Engine ao Folium
...
# Configurando método de renderização do Earth Engine no Folium
folium.Map.add_ee_layer = add_ee_layer

# Função para criar e filtrar uma coleção de imagens do GEE
...
# Função para processar arquivos GeoJSON enviados pelo usuário
...
# Função para processar a entrada de datas
...
def main():
    ee_authenticate(token_name="ee-marceloclaro")
